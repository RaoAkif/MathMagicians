...
describe('operate', () => {
  it('should return the input 1 + 1', () => {
  ...
  it('should return the input 2 + a', () => {
    expect(() => {
      operate('2', 'a', '+');
    }).toThrow(Error);
  });
